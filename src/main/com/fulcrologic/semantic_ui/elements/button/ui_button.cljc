(ns com.fulcrologic.semantic-ui.elements.button.ui-button
  ...
  Props:
    ...
    - icon (bool|string|object|element): Add an Icon by name, props object, or pass an <Icon />. ()
    - inverted (bool): A button can be formatted to appear on dark backgrounds.
    - label (string|object|element): Add a Label by text, props object, or pass a <Label />. ()
